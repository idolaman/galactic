    ...
    <div className="space-y-8 p-6">
      ...
      <Card className="border-border bg-card" id="mcp-installation">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <Card className="group relative flex flex-col items-center justify-between gap-4 border bg-background/70 p-6 text-center shadow-sm transition-all hover:border-primary/50 hover:shadow-md">
            <Button variant="ghost" size="icon" className="absolute right-2 top-2 h-6 w-6 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100" onClick={() => setSelectedConfig("Cursor")}>
              <Info className="h-4 w-4" />
            </Button>
          ...
          <Card className="group relative flex flex-col items-center justify-between gap-4 border bg-background/70 p-6 text-center shadow-sm transition-all hover:border-primary/50 hover:shadow-md">
            <Button variant="ghost" size="icon" className="absolute right-2 top-2 h-6 w-6 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100" onClick={() => setSelectedConfig("Claude")}>
              <Info className="h-4 w-4" />
            </Button>
          ...
          <Card className="group relative flex flex-col items-center justify-between gap-4 border bg-background/70 p-6 text-center shadow-sm transition-all hover:border-primary/50 hover:shadow-md">
            <Button variant="ghost" size="icon" className="absolute right-2 top-2 h-6 w-6 text-muted-foreground opacity-0 transition-opacity group-hover:opacity-100" onClick={() => setSelectedConfig("Codex")}>
              <Info className="h-4 w-4" />
            </Button>
